...
//    }
    ...
    private static void initModel() throws MalformedURLException {
        Cloud cloud = model.addCloud("http", "yandex.ru", 80,"index.html");
        ...
        cloud = model.addCloud("http", "google", 80, "index.html");
        ...
        cloud = model.addCloud("http", "yandex.ru", 80, "index.html");
